...
//This script is used during the attack stage to control the tiles and the linked ships.
public class TileAttackScript : MonoBehaviour
{
    ...
    public bool CheckHit(out ShipAttackScript hit)
    {
    ...
    void OnCollisionEnter(Collision col)
    {
        ...
        if (col.gameObject.tag == "Ship")
        {
            ...
            ship = col.gameObject.GetComponent<ShipAttackScript>();
        }
    }
}
